...
class TestCheckingAccount(unittest.TestCase):
    def setUp(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', delete=False, newline='') as temp:
            ...
            self.temp.write("account_id,first_name,balance_checking,balance_savings,status,overdraft_limit\n10001,suresh,2000,10000,active,-100\n10002,james,10000,10000,active,-100")
            self.temp.close()
    ...
    def test_withdraw(self):
        ...
        expected_value = [{"account_id": 10001, "first_name": "suresh","balance_checking": 0.0, "balance_savings": 10000.0, "status": "active","overdraft_limit": -100},
        ...
        expected_value = [{"account_id": 10001, "first_name": "suresh","balance_checking": -90.0, "balance_savings": 10000.0, "status": "inactive","overdraft_limit": -100},
                            {"account_id": 10002, "first_name": "james","balance_checking": 10000.0, "balance_savings": 10000.0, "status": "active","overdraft_limit": -100}]
        self.assertEqual(self.file.data_list , expected_value)
        ...
        self.file.data_list = [{"account_id": 10001, "first_name": "suresh","balance_checking": "none", "balance_savings": 10000.0, "status": "active","overdraft_limit": -100},
                            {"account_id": 10002, "first_name": "james","balance_checking": 10000.0, "balance_savings": 10000.0, "status": "active","overdraft_limit": -100}]
    ...
    def test_deposit(self):
        ...
        expected_value = [{"account_id": 10001, "first_name": "suresh","balance_checking": 2750.0, "balance_savings": 10000.0, "status": "active", "overdraft_limit": -100},
                            {"account_id": 10002, "first_name": "james","balance_checking": 10000.0, "balance_savings": 10000.0, "status": "active","overdraft_limit": -100}]
        ...
        self.file.data_list =  [{"account_id": 10001, "first_name": "suresh","balance_checking": -100.0, "balance_savings": 10000.0, "status": "inactive","overdraft_limit": -100}]
        expected_value = [{"account_id": 10001, "first_name": "suresh","balance_checking": 0.0, "balance_savings": 10000.0, "status": "active","overdraft_limit": -100}]
